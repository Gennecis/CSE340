...
//     data.forEach(vehicle => {
//       grid += `
//         <div>${vehicle.inv_description}</div>
//         <div><img src="${vehicle.inv_image}" alt="Image of ${vehicle.inv_make} ${
//       vehicle.inv_model
//     } on CSE Motors"></div>
//         <div>Price: $${new Intl.NumberFormat('en-US').format(vehicle.inv_price)}</div>
//          <div>Mileage: ${new Intl.NumberFormat('en-US').format(vehicle.inv_miles)}</div>
